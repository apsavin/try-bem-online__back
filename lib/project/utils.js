 ...
 * @param {String} [relativePath]
 */
var getFullPath = exports.getFullPath = function (projectId, relativePath) {
...
exports.exists = function (projectId, callback) {
    fs.exists(getFullPath(projectId), callback);
};

exports.bemPath = path.join(appPaths.examplePath, 'node_modules/bem');
exports.bemExecPath = path.join(exports.bemPath, '/bin/bem');
